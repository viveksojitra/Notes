            ...
            <nav className="nav-container">
                <div className="nav-wraper">
                    ...
                    <Link className="logo" to="/">
                        <img className="logo-img" src="/src/assets/GoogleKeep_LOGO.png" alt="Google Keep Logo" />
                    ...
                    <ul className="items">
                        ...
                        <li className='li-logout'>
                            <Dropdown className="m-0 p-0">
                                <Dropdown.Toggle className="m-0 p-0 border-0" variant="button" id="user-menu-dropdown">
